...
{
	public:
		BellmanFord(vector<vertix*> _v):m_vertices(_v){ AddEdge(); }
		vector<vertix*> m_vertices;
		bool RunBellAlgorithm();
...
void BellmanFord::initializeSingleSource(vertix& _v)
{
...
bool BellmanFord::RunBellAlgorithm()
{
...
int main()
{
	...
	vertix v5('z');
	v.push_back(&v5);
	BellmanFord _bellman(v);
	cout <<_bellman.RunBellAlgorithm() << endl;
    cout << _bellman.m_vertices;	
	cout << endl;
	return 0;
}
